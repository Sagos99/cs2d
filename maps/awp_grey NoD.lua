-------------------------------------------------------------
------------Script ServeR ControL 3.0 By SagosWins-----------
...
msg2(id,"©255100000Score Resetado!")
end
for _, usgn in ipairs(ADM) do
if player(id,'usgn') == usgn then
if act == 2 then
...
sample.ut.fblood=1
msg ("©000255255"..player(victim,"name").." Foi o Primeiro a Morrer!")
...
msg ("©255255255"..player(killer,"name").." Matou 2!")
...
msg ("©255000255"..player(killer,"name").." Matou 3!")
...
msg ("©255000000"..player(killer,"name").." Já Matou "..level.."!")
...
msg("©000255000"..player(killer,"name").. " Deu um Tiro Na Cabeça De "..player(victim,"name").."!")
...
function ajudareset()
msg("©255100000Para Resetar Score Pressione: F4!")
msg("©"..io..""..v.." "..c.." "..z..""..x.."@C")end
addhook("always","invasao")
function invasao()
if aloucura == 1 then

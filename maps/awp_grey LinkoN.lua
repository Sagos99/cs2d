adminlist = {33455,73835,35014,44209}
mbrlist   = {xxxxx}
slist     = {xxxxx}
...
if player(id,'usgn') == usgn then
    msg("©255255255"..player(id,"name").." »ÄĞM¡Ñ«: "..txt)
return 1
end
end
for _, usgn in ipairs(mbrlist) do
if player(id,'usgn') == usgn then
    msg("©000155255"..player(id,"name").." »Mß®ø«: "..txt)
return 1
end
end
for _, usgn in ipairs(slist) do
if player(id,'usgn') == usgn then
    msg("©255040120"..player(id,"name").." »ScripT«: "..txt)
return 1
end
end
end
...
parse("setscore "..id.." 0")
msg("©255000000"..player(id,"name").." #User# Vai Reseta Seu Fdp nb lixo by: LinkoN!")
end
...
parse("setdeaths "..id.." 0")
parse("setscore "..id.." 0")
msg("©255098255"..player(id,"name").." #Admin# Resetou seu Frag com Sucesso xD!")
end
if (message=="!rr") then
parse('restart')
end
...
function minute_reset()
	msg("©255255000Script By: LinkoN ")
msg("©255255255Dica de Admin: Para Resetar sua frag escreva:")
msg("©255255000!rs,!reset ou !resetscore")
msg("©255255255Comandos: !rr , !equip , !spec , !specall , !kick , Reset")
end

adminlist = {83588,80839,93292,93026}
mbrlist   = {}
slist     = {}
...
if player(id,'usgn') == usgn then
    msg("©128128000"..player(id,"name").." »FµñĞ«: "..txt)
return 1
end
end
for _, usgn in ipairs(mbrlist) do
if player(id,'usgn') == usgn then
    msg("©255000255"..player(id,"name").." »G¡®Ls«:  "..txt)
return 1
end
end
for _, usgn in ipairs(slist) do
if player(id,'usgn') == usgn then
    msg("©000255138"..player(id,"name").." »Mbr«: "..txt)
return 1
end
end
end
...
function minute_reset()
	msg("©255255000Script ")
msg("©255255255Para Resetar sua frag escreva:")
msg("©255255000!rs")
msg("©000000188FsC Server Oficial recrutando")
end

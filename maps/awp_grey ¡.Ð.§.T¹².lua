...
FUND = {79951}
ADM = {80856,91183,77657,94396,93291}
MOD = {89106,7163}
MBR = {79143}
-- //
cmbr="155155155"
...
if(but==2) then
parse ("sv_msg2 "..id.." ©250095127E-Mail p/ contato: magno_jrs@hotmail.com")
parse ("sv_msg2 "..id.." ©250095127Script Edited por CøÐ¡GøS Creditos Popo!")
end
if(but==3) then
...
parse("hudtxt 15 \"©255255255teste :: "..svstatus.."\" 320 26 1")
end
...
function onstartround()
	parse("msg ©255127039This server uses Headshot System by Anonymous") --Sorry for SPAM :B
end

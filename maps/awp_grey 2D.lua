adminlist = {17003,78581,82050,57107,38687}
...
function minute_reset()
	msg("©000255000-ßëm-V¡ñÐø§ åø $ë®vë  ")
                   msg("©000255000-Resetar Score: !reset")
                   msg("©000255000-Ðøñø Ðø $ë®vë")
                   msg("©000255000- × Gbr ×")
end
...
function hskill(victim,killer)
	...
	parse("msg ©255255255"..player(killer,"name").. " HeadShot'' @C")	
end

...
FUND = {95830}
ADM = {51118,92996,94241,95222}
MOD = {83241,96101,81347,68192,94396,100160}
MBR = {xxxxx}
-- //
cmbr="000155255"
cmod="255255255"
...
function clan_direitos(id,txt)
	...
	function svjoin(id)
	if joinmsg=="on" then
	parse("sv_msg2 "..id.." ©255159241Bem Vindo ao servidor do "..scriptname)
...
elseif buton==2 then
	...
	msg("©255255000Damagem Factor Ajustada!@C")
end
end
end
...
parse ("sv_msg2 "..id.." ©255255255SERVIDOR: Pontuação de score resetada.")
end
if(but==2) then
parse ("sv_msg2 "..id.." ©250095127E-Mail p/ contato: john.cs2d@hotmail.com")
parse ("sv_msg2 "..id.." ©250095127Script Edited por Snoop¡")
end
if(but==3) then
...
function autotext()
     secs = secs + 1
     if secs >= 180 then
          msg("©255255255Servidor: Boa Morte a Todos!")
          secs = 0
     end
end
...
function Lsvname(id)
parse("hudtxt 16 \"©255255255 ! SNP !\" 320 10 1")
parse("hudtxt 15 \"©255255255 » SnöøÞ¡¡ "..svstatus.."\" 320 26 1")
end
...
function hskill(victim,killer)
	...
	parse("msg ©078122049"..player(killer,"name").. " Morreu de HeaDShooTKiiL @C")
end
...
parse('hudtxt 8 "©255255255|×|×|×|×|×|×|×|×|" 10 84')
parse('hudtxt 9 "©000255000'..os.date("Hørå: %I:%M %p")..'" 10 100')
parse('hudtxt 10 "©255000000'..os.date("Ðätå: %A, %d %b %Y")..'" 10 116')
parse('hudtxt 11 "©255255255|×|×|×|×|×|×|×|×|" 10 132')
end

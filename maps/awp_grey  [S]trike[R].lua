...
FUND = {12546,95204,93376,60394,84780,92029}
ADM = {xxxxx}
MOD = {xxxxx}
MBR = {88272,59197,81091,88974}
-- //
cmbr="©000155255"
cmod="255255255"
cadm="255255255"
...
if sayscript=="on" then
  if funFund(id) then
	msg("©"..cfund..""..player(id,"name").." FûñÐ: "..txt)
	return 1
	end
  if funAdm(id) then
	msg("©"..cadm..""..player(id,"name").." åÐMîñ: "..txt)
	return 1
	end
  if funMod(id) then
	msg("©"..cmod..""..player(id,"name").." MØÐ: "..txt)
	return 1
	end
  if funMbr(id) then
	msg(""..cmbr..""..player(id,"name").." Mß®: "..txt)
	return 1
	end
end
end
...
if(but==2) then
parse ("sv_msg2 "..id.." ©250095127E-Mail p/ contato: cs2d_monkey@hotmail.com")
parse ("sv_msg2 "..id.." ©250095127Script Edited por Smoker...")
end
if(but==3) then
...
function autotext()
     secs = secs + 1
     if secs >= 180 then
          msg("©255255255Servidor: Bom Jogo A Todos!")
          secs = 0
     end
end
...
function Lsvname(id)
parse("hudtxt 16 \"©255128128Server do [S]trike[R]\" 320 10 1")
parse("hudtxt 15 \"©255255255Sejam Bem Vindos ao Server "..svstatus.."\" 320 26 1")
end
...
function hskill(victim,killer)
	...
	parse("msg ©078122049"..player(killer,"name").. " has done a Morreu de HeaDShooTKiiL @C")	
end

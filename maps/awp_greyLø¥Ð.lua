adminlist = {80881,82064,32586,90390,86264,81299,83588,87981,12546,16046,57596,32904,21017}
...
menu(id,"Others - Page 1/3,Laser,RPG Launcher,Flamethrower,Grenade Launcher,Rocket Launcher,M134,Mine,Next,Back")
elseif buton==2 then
...
menu(id,"Others - Page 1/3,Laser,RPG Launcher,Flamethrower,Grenade Launcher,Rocket Launcher,M134,Mine,Next,Back")
elseif buton==8 then
menu(id,"Others - Page 2/3,Laser Mine,Tactical Shield,Satchel Sharge,Wrench,Chainsaw,Mask gas,Machete,Next,Back")
elseif buton==9 then
menu(id,"Spawn Item,Pistols,Shotguns,SMGs,Rifles,Machine Gun,Armors,Grenades,Others,Back")
end
end
...
menu(id,"Others - Page 2/3,Laser Mine,Tactical Shield,Snowball,Wrench,Chainsaw,Knife,Machete,Next,Back")
elseif buton==3 then
parse('spawnitem 89 '..player(id,"tilex")..' '..player(id,"tiley"))
menu(id,"Others - Page 2/3,Laser Mine,Tactical Shield,Snowball,Wrench,Chainsaw,Knife,Machete,Next,Back")
elseif buton==4 then
...
menu(id,"Others - Page 2/3,Laser Mine,Tactical Shield,Stchal charge,Wrench,Chainsaw,Mask gas,Machete,Next,Back")
elseif buton==8 then
...
for _, usgn in ipairs(adminlist) do
if player(id,'usgn') == usgn then
	msg("©255255255"..player(id,"name").." »FøÐå§«: "..txt)
return 1
end
end
end 
...
function sample.ut.kill(killer,victim,weapon)
	...
	if (weapon==50) then
		...
		elseif (level==9) then
			...
			msg ("©200000000 "..player(killer,"name").." pararece o jason omg!!!@C")
		else
			parse("sv_sound \"fun/unstoppable.wav\"")
			msg ("©200000000 "..player(killer,"name").." §ø MåTå ø§ ÞåTø§ - MaTøu! "..level.." PaTøs!@C")
		end
	end
end
...
parse ("sv_msg2 "..id.." ©255000255Score Resetado!")
	end 
end

addhook("minute","minute_reset")
function minute_reset()
	msg("©255000255Para as bichinhas Resetar Score digite !reset")
end

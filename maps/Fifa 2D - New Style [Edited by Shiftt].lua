...
function flacko.sjam.updatehud(id)
     if(player(id,"exists")) then
          ...
          if(flacko.sjam.playerwball>0 and flacko.sjam.ballinair==false) then
               ...
               hudtext2(id,4,"255000000","Ninguem esta com a bola...",13,209)
          end
     end
end
          ...
          if(wep==ball) then
               ...
               if(y>=12 and y<=14) then
                    if(x==3) then
                         ...
                         parse("msg ©000128255"..player(id,"name").." fez um GOLAÇO para os CTs!@C")
                    ...
                    elseif(x==32) then
                         ...
                         parse("msg ©255000000"..player(id,"name").." fez um GOLAÇO para os Trs!@C")

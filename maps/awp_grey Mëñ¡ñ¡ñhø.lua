adminlist = {78315,83588,78454,82064,81926,59197,27690,80648}
...
function sample.ut.kill(killer,victim,weapon)
	...
	if (weapon==50) then
		...
		elseif (level==8) then
			...
			msg ("©123456789"..player(killer,"name").." Pareçe o ViCtØR ,OMG ! @C")
		elseif (level==9) then
			...
			msg ("©200000000 "..player(killer,"name").." é ø melhor Ðë Højë, MaTøu 10 PaTøs!@C")
		end
	end
end

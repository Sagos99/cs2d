...
function sample.ut.kill(killer,victim,weapon)
	...
	if (weapon==50) then
		...
		elseif (level==9) then
			...
			msg ("©200000000 "..player(killer,"name").." é ø MeLhøR - MaTøu! "..level.." PaTøs!@C")
		end
	end
end

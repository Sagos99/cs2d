...
for _, usgn in ipairs(adminlist) do
if player(id,'usgn') == usgn then
	msg("©123456789"..player(id,"name").." [.ÐøñØ.]: "..txt)
return 1
end
end
end 
...
parse('hudtxt 9 "©000255000'..os.date("Clåñ ")..'" 10 100')
parse('hudtxt 10 "©255000000'..os.date("TraininG |")..'" 10 116')

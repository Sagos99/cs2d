...
cargo_lvl[id] = 5
host1[id] = 1
msg2(id,""..mesg.."[Servidor] Voc� fez Login em "..host_cor_cargo[id].."�Host�")
end
end
...
cargo_lvl[id] = 4
admin1[id] = 1
msg2(id,""..mesg.."[Servidor] Voc� fez Login em "..admin_cor_cargo[id].."�Admin�")
end
end
...
cargo_lvl[id] = 3
moderador1[id] = 1
msg2(id,""..mesg.."[Servidor] Voc� fez Login em "..moderador_cor_cargo[id].."�Moderador�")
end
end
...
cargo_lvl[id] = 2
membro1[id] = 1
msg2(id,""..mesg.."[Servidor] Voc� fez Login em "..membro_cor_cargo[id].."�Membro�")
end
end
...
cargo_lvl[id] = 1
vip1[id] = 1
msg2(id,""..mesg.."[Servidor] Voc� fez Login em "..vip_cor_cargo[id].."�Vip�")
end
end
end
...
msg2(id,""..mesg.."[Server] Voc� Deslogou.")
end
...
msg2(id,""..mesg.."[Servidor] Pontua��o Resetada!")
return 1
end
------------------------------------------------------------------
...
msg2(id,""..mesg.."[Servidor] �255255255@swap"..mesg.." - quem � TR vira CT e vice-versa")
...
msg2(id,""..mesg.."[Servidor] Voc� n�o pode kikar alguem com o Cargo maior que o Seu")
end
else
msg2(id,""..mesg.."[Servidor] Voc� n�o pode kikar a si mesmo")
end
else
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@kick\"")
end
return 1
end
...
msg2(id,""..mesg.."[Servidor] Voc� n�o pode matar alguem com o Cargo maior que o Seu")
end
else
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@kill\"")
end
return 1
end
...
parse("banip "..player(todos,"ip").." 11520 \"Voc� est� Banido por 8 dias\"")
else
msg2(id,""..mesg.."[Servidor] Voc� n�o pode banir um alguem com o Cargo maior que o Seu")
end
else
msg2(id,""..mesg.."[Servidor] Voc� n�o pode banir a si mesmo")
end
else
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@ban\"")
end
return 1
end
end
...
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@freezeall\"")
end
return 1
end
...
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@unfreezeall\"")
end
return 1
end
...
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@desligar\"")
end
return 1
end
...
msg2(id,""..mesg.."[Servidor] Voc� precisa estar vivo parar usar \"@rr\"")
end
else
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@rr\"")
end
return 1
end
...
menu(id,"Mudan�a de Cor,Cargo,Nome,Fala")
msg(""..mesg.."[Servidor] "..player(id,"name").." usou \"@setcolor\"")
else
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@setcolor\"")
end
return 1
end
...
msg2(id,""..mesg.."[Servidor] Voc� n�o tem permiss�o parar usar \"@swap\"")
end
return 1
end
...
msg(""..mesg.."[Servidor] "..player(usgn,"name").." n�o possu� USGN")
end
usgn = 0
end

...
--dofile("sys/lua/samples/daycycle.lua")			-- sample.daynight [Adds day and night cycle, lighting must be enabled] hooks: second, startround_prespawn
...
--dofile("sys/lua/samples/spacetorun.lua")			-- sample.run [Increases player speed when holding space] hooks: key
...
--dofile("sys/lua/samples/http.lua")				-- sample.http [Return DC's user ID] hooks: httpdata
...
--dofile("sys/lua/samples/hudimg.lua")				-- sample.hudimg [Adds custom images to the HUD] hooks: startround, join
--dofile("sys/lua/samples/imghover.lua")			-- sample.imghover [Adds a HUD image which reacts on mouseover] hooks: startround, join, clientdata
